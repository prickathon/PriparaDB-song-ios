...
//    public func flatten() -> Future<Value.Value.Value, Error> {
...
//                        return Result<Self.Value.Value.Value, Self.Error>(value: $0)
//                    }, ifFailure: {
//                        return Result<Self.Value.Value.Value, Self.Error>(error: $0)
//                    }))
//                }
//            }, ifFailure: {
//                complete(Result<Any, Self.Error>(error: $0))
//            })
//        }
//    }
//}
